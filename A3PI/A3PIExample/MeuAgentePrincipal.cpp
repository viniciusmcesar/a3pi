...
void AIConstrutora (Unidade* u){
	...
	amigoDaVez = NULL;//vai ser escolhido de novo antes mesmo do predio terminar...
}
...
void AICentroComando (Unidade* u){
	...
	}//Lembrar que ha varias threads rodando em paralelo. O erro presente neste metodo nao resulta em crash do jogo, mas outros poderiam.
}
